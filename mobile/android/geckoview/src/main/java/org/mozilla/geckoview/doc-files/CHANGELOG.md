...
- Added [`IPProtectionController.switchTo(Country)`][153.10] to switch the active proxy connection to a server in a different country, resolving to whether the connection was switched.
...
[153.10]: {{javadoc_uri}}/IPProtectionController.html#switchTo(org.mozilla.geckoview.IPProtectionController.Country)
...
[api-version]: 763edcba86dd510a921c1a4778dae99abc854cd4
